<div id="dashboard">
    <div id="topSect">
        <ul id="optsCfg">
            <li class="optCfg"><a style="display: inline-block;" id="optAddEMP" class="adminOpt">Registrar Empleado</a></li>
            <li class="optCfg"><a style="display: inline-block;">Añadir Tienda</a></li>
