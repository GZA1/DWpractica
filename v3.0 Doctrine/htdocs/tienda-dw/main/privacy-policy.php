...
<html>
    ...
    <body>
        ...
        <div style="background-color: white; padding: 1%">
            ...
            <p>Fecha efectiva: January 16, 2019</p>
            <p>My Site ("nosotros", "a nosotros", "nuestro") opera el sitio web http://www.mysite.com (en adelante, el "Servicio").</p>

            <p>Esta página le informa de nuestras políticas en materia de recopilación, uso y divulgación de datos personales cuando utiliza nuestro Servicio y de las opciones de las que dispone en relación con esos datos. <a href="https://termsfeed.com/blog/sample-privacy-policy-template/">TermsFeed Plantilla de política de privacidad</a>.</p>

            <p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el http://www.mysite.com</p>

            <h2>Definiciones</h2>
            <ul>
                <li>
                    <p><strong>Servicio</strong></p>
                            <p>Servicio es el sitio web http://www.mysite.com operado por My Site</p>
                        </li>
                <li>
            ...
            <h2>Uso de datos</h2> 
            <p>My Site utiliza los datos recopilados con diversas finalidades:</p>    
            <ul>
            ...
            <ul>
                    <li>Por e-mail: example@mail.com</li>

                    <li>A través del número de teléfono: 999887766</li>
            </ul>
        </div>
    </body>
